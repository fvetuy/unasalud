...
const muestraActividadesInicio = () => {
  return (
      ...
      <section id='muestraActividades' className="flex justify-center items-center flex-col sm:flex-row flex-wrap sm:mb-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          {[...actividades].slice(0, 3).map((actividad) => (
           <div key={actividad.id} className={`${styles.flexStart} flex-1 flex flex-col mt-2 sm:py-12 pb-6 px-8 bg-dimWhite rounded-xl cursor-pointer`}>
              <a href={`${"actividades/" + actividad.id.toLowerCase()}`}>
